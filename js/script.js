$(document).ready(function () {
  ...
  const projectData = [{
    ...
    },
    {
      ...
      text: '<p>Angular project.  Connects to opentdb API, get random questions. <br><b>URL: </b> <a href="https://github.com/ssharm02/JeopardyAngular" target="_blank"><i>Angular Jeopardy Game</i></a><br><p><b>Code:</b> Angular<br></p>',
  ...
  showProjectCards = () => {
    ...
    projectData.forEach(function (project) {
      ...
      if (typeof project.site[1] !== 'undefined') {
        html +=
          `<a data-toggle="tooltip" title="${project.site[1][0]}" data-placement="top" href="${project.site[1][2]}" target="_blank" class="btn btn-primary btn-lg btn-circle btn-lnk btn-lnk1"><i class="fa${project.site[1][1]}" aria-hidden="true"></i></a>`;
      }
